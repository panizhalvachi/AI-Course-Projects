        ...
        if self.storage_colours:
            if disable_terminal_colouring:
                for storage_point in self.storage:
                    map[storage_point[1]][storage_point[0]] = self.storage_colours[self.storage[storage_point]][
                                                              0:1].upper()
            else:
                for storage_point in self.storage:
                    map[storage_point[1]][storage_point[0]] = bg_colours[self.storage_colours[
                        self.storage[storage_point]]] + '.' + bg_colours['normal']
        else:
        ...
        if self.box_colours:
            if disable_terminal_colouring:
                ...
                for box in self.boxes:
                    if box in self.storage:
                        if self.restrictions is None or box in self.restrictions[self.boxes[box]]:
                            map[box[1]][box[0]] = bg_colours[self.storage_colours[self.storage[box]]] + fg_colours[
                                self.box_colours[self.boxes[box]]] + '$' + bg_colours['normal']
                        else:
                            map[box[1]][box[0]] = bg_colours[self.storage_colours[self.storage[box]]] + fg_colours[
                                self.box_colours[self.boxes[box]]] + 'x' + bg_colours['normal']
                    else:
...
PROBLEMS = (
    ...
    SokobanState("START", 0, None, 6, 4,  # dimensions
                 ...
                 (frozenset(((0, 0),)), frozenset(((2, 0),)), frozenset(((1, 0),)), frozenset(((1, 1),))),
                 # restrictions,
    ...
    SokobanState("START", 0, None, 6, 4,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(4, 6, 0, 1)
                            + generate_coordinate_rect(0, 3, 3, 4))),  # obstacles
                 (frozenset(((0, 0),)), frozenset(((2, 0),)), frozenset(((1, 0),)),
                  frozenset(((0, 0), (2, 0), (1, 0), (1, 1),))),  # restrictions,
    ...
    SokobanState("START", 0, None, 8, 6,  # dimensions
                 ...
                 (frozenset(((7, 0),)), frozenset(((7, 1),)), frozenset(((7, 2),)), frozenset(((7, 3),)),
                  frozenset(((7, 4),))),  # restrictions,
    ...
    SokobanState("START", 0, None, 6, 5,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(4, 6, 0, 1)
                           ...
                           + [(1, 1), (1, 3)]),  # obstacles
                 (frozenset(((1, 2),)), frozenset(((2, 2),)), frozenset(((3, 2),)), frozenset(((0, 2),)),
                  frozenset(((7, 4),))),  # restrictions,
                 {0: 'cyan', 1: 'magenta', 2: 'yellow', 3: 'red', 4: 'green'},  # box colours
                 {0: 'cyan', 1: 'magenta', 2: 'yellow', 3: 'red', 4: 'green'}  # storage colours
                 ),
